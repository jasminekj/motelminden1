...
export function Hero() {
  return (
    <section id="home" className="relative min-h-[100svh] w-full overflow-hidden">
      <Image
        src="/images/hero.png"
        alt="Scenic lake and pine forest landscape in the Haliburton Highlands near Motel Minden"
        fill
        priority
        sizes="100vw"
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-4xl flex-col items-center justify-center px-5 pt-16 text-center text-white">
        ...
        <h1 className="text-balance font-serif text-4xl font-semibold leading-[1.05] tracking-tight sm:text-6xl md:text-7xl">
          Your Stay in the Heart of Minden
        </h1>
        <p className="mt-6 max-w-xl text-pretty text-base leading-relaxed text-white/90 sm:text-lg">
          Comfortable, convenient accommodations surrounded by lakes, forest, and
          the natural beauty of Ontario&apos;s cottage country.
        </p>
...
export function Intro() {
  return (
    <section id="intro" className="bg-background py-20 sm:py-28">
      <div className="mx-auto max-w-3xl px-5 text-center sm:px-8">
        ...
        <p className="mt-6 text-pretty text-lg leading-relaxed text-muted-foreground">
          ...
          country. Whether you&apos;re here for the lakes, the trails, a downtown
